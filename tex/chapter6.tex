...
\begin{table}
\caption{\en{x86 Processor Exceptions Table}}
\centering
\begin{tabular}{ | l | l | l |}
\hline  
...
تعتبر مشابك المتحكم هي  طريقة ارسال البيانات من المتحكم الى المعالج (أو الى متحكم رئيسي) ، ونظراً لان كل مشبك لديه وظيفة محددة فانه يجب دراسة هذه المشابك ولكن لن نفصِّل كثيراً حيث أن الموضوع متشعب ويخص دراسي المنطق الرقمي (\en{Digital Logic}). ويوضح الشكل \ref{fig:pic_pins} هذه المشابك.
...
مؤخرا تم نقل المؤقتة من اللوحة الأم (\en{MotherBoard}) كشريحة \en{DIP} مستلقة الى الجسر الشمالي (\en{SouthBridge}). وسوف نركز على برمجة العداد الأول وهو مؤقت النظام حيث أنه يوفر الدعم العتادي اللازم للنظام حتى يدعم تعدد العمليات والمسالك.
