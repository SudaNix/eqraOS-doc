...
\lstinputlisting[label=lst:bootloader,caption=Some Code]{../examples/ch3/ex3/ex3.asm}
\end{english}
...
\lstinputlisting[label=lst:bootloader,caption=Some Code]{../examples/ch3/ex4/ex4.asm}
\end{english}
...
\lstinputlisting[label=lst:bootloader,caption=Some Code]{../examples/ch3/ex5/ex5.asm}
\end{english}
...
\lstinputlisting[label=lst:bootloader,caption=Some Code]{../examples/ch3/ex6/stage2.asm}
\end{english}
...
\lstinputlisting[label=lst:bootloader,caption=Some Code]{../examples/ch3/ex7/ex7.asm}
\end{english}
...
\lstinputlisting[label=lst:bootloader,caption=Some Code]{../examples/ch3/ex8/ex8.asm}
\end{english}
...
\lstinputlisting[label=lst:bootloader,caption=Some Code]{../examples/ch3/ex9/ex9.asm}
\end{english}
...
\lstinputlisting[label=lst:bootloader,caption=Some Code]{../examples/ch3/ex10/ex10.asm}
\end{english}
...
\lstinputlisting[label=lst:bootloader,caption=Some Code]{../examples/ch3/ex11/ex11.asm}
\end{english}
...
\lstinputlisting[label=lst:bootloader,caption=Some Code]{../examples/ch3/ex12/ex12.asm}
\end{english}
...
\lstinputlisting[label=lst:bootloader,caption=Some Code]{../examples/ch3/ex13/ex13.asm}
\end{english}
...
\lstinputlisting[label=lst:bootloader,caption=Some Code]{../examples/ch3/ex14/ex14.asm}
\end{english}
