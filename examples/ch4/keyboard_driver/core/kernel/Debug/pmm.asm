; Listing generated by Microsoft (R) Optimizing Compiler Version 14.00.50727.42 
	...
	TITLE	c:\Documents and Settings\SudaNix\Desktop\eqraOS\eqraOS-doc\examples\ch4\keyboard_driver\core\kernel\pmm.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File c:\documents and settings\sudanix\desktop\eqraos\eqraos-doc\examples\ch4\keyboard_driver\core\kernel\pmm.cpp
...
; 183  : 		je enable
	...
	je	SHORT $enable$2729

; 184  : 		jmp disable

	jmp	SHORT $disable$2730
$enable$2729:
...
; 49   : 	for (uint32_t i=0;i<pmm_get_free_block_count()/32;++i) {
	...
	push	edi
	shr	esi, 5
	mov	DWORD PTR _i$2638[esp+36], eax
	mov	DWORD PTR $T2830[esp+36], esi
...
; 51   : 			for (int j=0;j<32;++j) {
	...
	xor	ecx, ecx
	mov	DWORD PTR _j$2643[esp+36], ecx
	npad	4
$LL32@mmap_find_@2:
...
; 62   : 						if (free_bit == s)
	...
	mov	ecx, DWORD PTR _j$2643[esp+36]
	mov	esi, DWORD PTR $T2830[esp+36]
...
; 51   : 			for (int j=0;j<32;++j) {
	...
	mov	eax, DWORD PTR _i$2638[esp+36]
$LN12@mmap_find_@2:
...
; 63   : 							return i*32+j;
	...
	pop	esi
	shl	eax, 5
	add	eax, DWORD PTR _j$2643[esp+28]
	pop	ebx
	pop	ebp
