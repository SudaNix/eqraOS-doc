; Listing generated by Microsoft (R) Optimizing Compiler Version 14.00.50727.42 
	...
	TITLE	c:\Documents and Settings\SudaNix\Desktop\eqraOS\eqraOS-doc\examples\ch4\vmm\core\kernel\main.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG2727	DB	'eqraOS kernel executed', 0aH, 00H
$SG2734	DB	'b1 allocataed 1 block at 0x%x: ', 0aH, 00H
	ORG $+3
$SG2735	DB	'b2 allocataed 2 blocks at 0x%x: ', 0aH, 00H
	ORG $+2
$SG2737	DB	'b1 re-allocataed at 0x%x: ', 0aH, 00H
	ORG $+4
$SG2740	DB	'                                  eqraOS v0.1           '
	DB	'                        ', 00H
	ORG $+7
$SG2741	DB	'                                                        '
	DB	'                        ', 00H
...
; File c:\documents and settings\sudanix\desktop\eqraos\eqraos-doc\examples\ch4\vmm\core\kernel\main.cpp
_TEXT	SEGMENT
...
; 60   : 	
; 61   : 	uint32_t* b1 = (uint32_t*)pmm_alloc();

	call	?pmm_alloc@@YAPAXXZ			; pmm_alloc

; 62   : 	uint32_t* b2 = (uint32_t*)pmm_allocs(2);
...
; 63   : 	
; 64   : 	kprintf("b1 allocataed 1 block at 0x%x: \n",b1);
...
; 65   : 	kprintf("b2 allocataed 2 blocks at 0x%x: \n",b2);
...
; 68   : 	b1 = (uint32_t*)pmm_alloc();

	call	?pmm_alloc@@YAPAXXZ			; pmm_alloc
	mov	esi, eax

; 69   : 	kprintf("b1 re-allocataed at 0x%x: \n",b1);
...
; 79   : 	kputs("                                  eqraOS v0.1                                   ");

	push	OFFSET $SG2740
	call	?kputs@@YAXPAD@Z			; kputs

; 80   : 	//kgoto_xy(0,1);
; 81   : 	//kputs("                          Ahmad Essam [suda.nix@hotmail.com]                    ");
; 82   : 	
; 83   : 	kgoto_xy(0,24);
