; Listing generated by Microsoft (R) Optimizing Compiler Version 14.00.50727.42 
	...
	TITLE	c:\Documents and Settings\SudaNix\Desktop\eqraOS\eqraOS-doc\examples\ch4\pmm\core\kernel\panic.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG2583	DB	0aH, 'Sorry, eqraOS has encountered a problem and has bee'
	DB	'n shutdown.', 0aH, 0aH, 00H
	ORG $+2
$SG2584	DB	'*** STOP: %s', 00H
CONST	ENDS
...
; File c:\documents and settings\sudanix\desktop\eqraos\eqraos-doc\examples\ch4\pmm\core\kernel\panic.cpp
_TEXT	SEGMENT
_msg$ = 8						; size = 4
