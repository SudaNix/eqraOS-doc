; Listing generated by Microsoft (R) Optimizing Compiler Version 14.00.50727.42 
	...
	TITLE	c:\Documents and Settings\SudaNix\Desktop\eqraOS\eqraOS-doc\examples\ch4\irq\core\kernel\main.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File c:\documents and settings\sudanix\desktop\eqraos\eqraos-doc\examples\ch4\irq\core\kernel\main.cpp
_TEXT	SEGMENT
_main	PROC
...
; 99   : 	
; 100  : 
; 101  : 	kset_color(WHITE_ON_RED);

	push	79					; 0000004fH
	call	?kset_color@@YAII@Z			; kset_color

; 102  : 
; 103  : 	kprintf("Entering PMode ....................................[ok]\n");

	push	OFFSET $SG2695
	call	?kprintf@@YAHPBDZZ			; kprintf
	add	esp, 64					; 00000040H

; 104  : 	kprintf("Initializing CRT ..................................[ok]\n");

	push	OFFSET $SG2696
	call	?kprintf@@YAHPBDZZ			; kprintf

; 105  : 	kprintf("Initializing GDT ..................................[ok]\n");

	push	OFFSET $SG2697
	call	?kprintf@@YAHPBDZZ			; kprintf

; 106  : 	kprintf("Initializing IDT ..................................[ok]\n");

	push	OFFSET $SG2698
	call	?kprintf@@YAHPBDZZ			; kprintf

; 107  : 	kprintf("Initializing PIC ..................................[ok]\n");

	push	OFFSET $SG2699
	call	?kprintf@@YAHPBDZZ			; kprintf

; 108  : 	kprintf("Initializing PIT ..................................[ok]\n");

	push	OFFSET $SG2700
	call	?kprintf@@YAHPBDZZ			; kprintf

; 109  : 	kprintf("Setup Error/Exception Handler .....................[ok]\n");

	push	OFFSET $SG2701
	call	?kprintf@@YAHPBDZZ			; kprintf

; 110  : 	
; 111  : 	//kprintf("CPU vendor is: %s\n",get_cpu_vendor());
; 112  : 	
; 113  : 	kset_color(BLACK_ON_GRAY);
...
; 118  : 		kprintf("Current tick count: %d\n",get_tick_count());
